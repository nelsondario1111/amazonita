        ...
        <section className="py-14 scroll-mt-24">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-4">
            {[
              ...
              <div
                key={c.t}
                className="rounded-[var(--radius-2xl)] bg-white p-6 shadow-[var(--shadow-soft)] transition-transform duration-500 hover:-translate-y-2 hover:scale-[1.01]"
              >
        ...
        <section id="servicios" className="py-14 scroll-mt-24">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {[
              ...
              <div
                key={s.t}
                className="rounded-[var(--radius-3xl)] bg-white p-7 shadow-[var(--shadow-soft)] transition-transform duration-500 hover:-translate-y-2 hover:scale-[1.01]"
              >
        ...
        <section id="galeria" className="relative overflow-hidden py-14 scroll-mt-24">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {[
              ...
              <ParallaxLayer key={item.src} speed={index % 2 === 0 ? 0.08 : -0.08}>
